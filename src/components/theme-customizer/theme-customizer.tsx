    ...
    <AppSheet
      ...
      header={
        <AppSheet.Header>
          <div className="flex items-center justify-between">
            <AppSheet.Title className="text-base font-semibold">
              Theme Settings
            </AppSheet.Title>
            <Button
              variant="ghost"
          ...
          <AppSheet.Description className="text-xs text-muted-foreground mt-1">
            Adjust appearance, colors, and layout. All changes apply live and
            save automatically.
      ...
      footer={
        <Link
          ...
          className="flex items-center justify-between w-full text-xs text-muted-foreground hover:text-primary transition-colors py-1"
        >
            ...
            {SIDEBAR_VARIANTS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.value === "floating" && (
                    <SquareDashedBottomCode className="size-3.5 text-primary" />
                  )}
